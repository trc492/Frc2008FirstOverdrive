...
unsigned char Camera_Serial_Port_Byte_Count(void)
{
	...
	return(SerialGetByteCount(SERIAL_PORT_ONE));
#else
	return(SerialGetByteCount(SERIAL_PORT_TWO));
#endif
}
...
{
#ifdef CAMERA_SERIAL_PORT_1
	return(SerialReadData(SERIAL_PORT_ONE));
#else
	return(SerialReadData(SERIAL_PORT_TWO));
#endif
}
...
{
#ifdef CAMERA_SERIAL_PORT_1
	SerialWriteData(SERIAL_PORT_ONE, value);
#else
	SerialWriteData(SERIAL_PORT_TWO, value);
#endif
}
